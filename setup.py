...
#
# This module is part of imgdt and is released under
...
setup(
    name = "imgdt",
    version = VERSION,
    description = "imgdt is a Python package that provides tools to convert and process images of a dataset",
